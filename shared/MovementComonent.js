export class MovementComponent {
    ...
    trackChanges() {
        ...
        if (this.prevX !== this.actor.pos.x)
            this.addNetworkUpdate("x", this.actor.pos.x);
        if (this.prevY !== this.actor.pos.y)
            this.addNetworkUpdate("y", this.actor.pos.y);
    ...
    getAndClearUpdates() {
        const updates = Object.assign({ id: this.actor.id }, this.updates);
        this.updates = {};
        this.needsUpdate = false;
        return updates;
    }
