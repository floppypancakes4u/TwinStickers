...
export class MovementComponent {
  ...
  applyNetworkMovementUpdate(updateData: MovementUpdate) {
    ...
    if (updateData.x !== undefined) this.prevX = updateData.x;
    if (updateData.y !== undefined) this.prevY = updateData.y;
    if (updateData.rotation !== undefined) this.prevRotation = updateData.rotation;
    if (updateData.velocity !== undefined) this.prevVelocity = updateData.velocity;
  ...
  applyForce(actor: FlightActor, amt: number, direction: number = 0) {
